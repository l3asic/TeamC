...
public class JoinController {
	...
	@ResponseBody
	   @RequestMapping("/tend_list")
	   public String tend_list(HttpServletRequest req, HttpServletResponse res, HttpSession session) throws IOException {
	      req.setCharacterEncoding("UTF-8");
	      res.setCharacterEncoding("UTF-8");
	      res.setContentType("text/html");
	      String member_id = req.getParameter("member_id");
	      TendVO vo = sql.selectOne("login.mapper.tend_data", member_id);
