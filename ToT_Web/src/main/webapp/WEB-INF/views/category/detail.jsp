                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                       ...
                       <div class="add-to-btn" style="display: inline-block;">
							...
							<ul>
								<li><img src="images/like.png" alt="" style="margin-right: 5px">좋아요<strong>5</strong><li>
								<li><img src="images/comment.png" alt="" style="margin-right: 5px">댓글<strong>5</strong><li>
							</ul>
						</div>
                       <div>
