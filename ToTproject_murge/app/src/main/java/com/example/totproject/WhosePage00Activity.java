...
public class WhosePage00Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whosepage_tv_member_id.setText(member_id);
        whosepage_tv_board_cnt.setText(member_id);
        Intent getIntent = getIntent();
        int tabCode = getIntent.getIntExtra("tabCode", 0);
        String tabText = getIntent.getStringExtra("fromWhere");

        if (tabCode == 1) {
            Fragment03BoardTab fragment03BoardTab = new Fragment03BoardTab(WhosePage00Activity.this, getSupportFragmentManager(), "whosePage_write");
            ...
            Fragment03BoardTab fragment03BoardTab = new Fragment03BoardTab(WhosePage00Activity.this, getSupportFragmentManager(), "whosePage_likes");
            ChangeView.viewFrament(R.id.whosepage_container, fragment03BoardTab, getSupportFragmentManager());
        } else if (tabCode == 3) {
    ...
    /* =============================== 메소드 ============================= */
    public void setActTexts(String member_id) { //생성자만으로 안되면 이거 실행해야함
        whosepage_tv_member_id.setText(member_id);
        whosepage_tv_board_cnt.setText(member_id);
    }
}