...
public class BoardTabAdapter extends RecyclerView.Adapter<BoardTabAdapter.Viewholder> {
    ...
    public BoardTabAdapter(Context context, ArrayList<BoardCommonVO> list) {
        ...
        public void bind(@NonNull Viewholder holder, int position, FragmentManager manager) {
            ...
            holder.board_user_list_item.setOnClickListener(new View.OnClickListener() {
             ...
             /*       Intent intent = new Intent(context, MainBurger01NoticeFgDetailAct.class);
                    ...
                    Fragment03BoardTab_Detail fragment03BoardTab_detail = new Fragment03BoardTab_Detail(context, manager, list.get(position));
                    manager.beginTransaction().replace(R.id.main_container, fragment03BoardTab_detail).addToBackStack(null).commit();
                }
            });
            /* ====================================================================== */
