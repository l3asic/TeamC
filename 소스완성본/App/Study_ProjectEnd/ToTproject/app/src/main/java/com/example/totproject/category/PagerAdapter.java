...
public class PagerAdapter extends RecyclerView.Adapter<PagerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.bindSliderImage(holder , position);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bindSliderImage(@NonNull ViewHolder holder, int position) {
//            Glide.with(context)
//                    .load(imageURL)
//                    .into(imageView);
            ...
            Glide.with(context)
                    .load(CommonAsk.IP+CommonAsk.SVRPATH+list.get(position).getPicture_filepath())
                    .into(imageView);
        }
    }
}
