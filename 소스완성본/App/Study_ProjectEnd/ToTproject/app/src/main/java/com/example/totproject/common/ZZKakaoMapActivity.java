...
public class ZZKakaoMapActivity extends AppCompatActivity implements net.daum.mf.map.api.MapView.MapViewEventListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zz_kakaomap_act);
        ...
        tv_refresh_location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LocationManager manager = (LocationManager) getSystemService(Context.LOCATION_SERVICE);
                if (ActivityCompat.checkSelfPermission(ZZKakaoMapActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ZZKakaoMapActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    // TODO: Consider calling
                    //    ActivityCompat#requestPermissions
                    // here to request the missing permissions, and then overriding
                    //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode ==ADDR_REQ_CODE && resultCode == RESULT_OK){
            ...
            Geocoder geocoder = new Geocoder(ZZKakaoMapActivity.this);
            try {
                ...
                if(list != null){
                    ...
                    MapReverseGeoCoder reverseGeoCoder = new MapReverseGeoCoder("8925876f611b3b4ee7f7c9c830957654",
                            ...
                            this,
                            ZZKakaoMapActivity.this); reverseGeoCoder.startFindingAddress();
                }else{
