...
<header style="border-bottom: 1px solid #ccc; padding : 15px 0; text-align : left">
	<div class='category' style="margin-left: 200px;">
		<ul>
			<li><a href='<c:url value="/" />'> <img src="imgs/logo_tot2.png"></a></li>
			<li><a href="list.ho" ${category eq 'ho' ? "class='active'" : '' } >home</a></li>
			<li><a href="list.ca" ${category eq 'ca' ? "class='active'" : '' } >category</a></li>
			<li><a href="list.bo" ${category eq 'bo' ? "class='active'" : '' }>board</a></li>
			<li><a href="list.no" ${category eq 'no' ? "class='active'" : '' }>방명록</a></li>
		</ul>
