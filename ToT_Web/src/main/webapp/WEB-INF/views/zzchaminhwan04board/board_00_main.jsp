...
<body>
	...
	<form action="board_detail" method="post">
		<input type="hidden" name='board_sn' value=""></input> <input
			type="hidden" name='board_class' value=""></input>
	</form>

	<script type="text/javascript">
		function go_detail(board_sn, board_class) {
			$('[name = board_sn]').val(board_sn);
			$('[name = board_class]').val(board_class);
