				...
				<div class="col-xl-7 col-lg-7 col-md-6">
					<div class="single-product-details">
						...
						<c:if test="${loginInfo.member_grade eq 'master' }">
							<span style=""><a
								style="font-size: 10px; color: #666666; float: right; margin-top: 20px; position: absolute; left: 96%;"
								href="board_delete?board_sn=${vo.board_sn}">
									삭제 </a></span>
							<span style=""><a
								style="font-size: 10px; color: #666666; float: right; margin-top: 50px; position: absolute; left: 96%;"
								href="tend_category?board_sn=${vo.board_sn}">
									성향 </a></span>
						</c:if>
						<!-- =============== -->
