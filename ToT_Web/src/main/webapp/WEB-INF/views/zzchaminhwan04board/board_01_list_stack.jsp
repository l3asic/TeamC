						...
						<table class="table">
							...
							<thead>
								<tr>
									...
									<td class="price-pr"
										style="background: #BDEDFF; color: #999999;"><c:if
											test="${! empty loginInfo}">
											<a class="btn hvr-hover" href="board_new"
							...
							<tbody>
								<c:forEach items="${boardVO }" var="vo">
									...
									<tr style="height: 89px">
										<th class="thumbnail-img"><c:if
											...
											style="margin: 0px 5px; background: #2ba0da; color: #ffffff; border-radius: 30px;">${vo.member_id} [${vo.member_grade}]
										</a> <a
								...
								<tr style="text-align: center;">
									...
									<td colspan="6"><a id='btn_stacks' onclick="stacks_more()"
										class="btn hvr-hover bg_new_blue"
										style="background: #2ba0da; color: #ffffff">더보기</a></td>
								</tr>
							</tbody>
						</table>
					</div>
