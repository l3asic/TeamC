...
<body>
	...
	<form action="mark.jsp" method="post" onsubmit="return fnSubmit()"
		...
		<div class="omr">
			...
			<div class="btns">
				<div>
					<input class="btn btn-outline-success btn-sm" type="submit" value="제출하기" onclick="location.href='mark.jsp'" />
				</div>
				<div>
					<input class="btn btn-outline-warning btn-sm" type="reset" value="초기화하기" />
				</div>
				<div>
