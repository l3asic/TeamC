...
<c:choose>
	<c:when test="${category eq 'ho' }"><c:set var='title' value="home"/> </c:when>
	<c:when test="${category eq 'ca' }"><c:set var='title' value="category"/> </c:when>
	<c:when test="${category eq 'bo' }"><c:set var='title' value="board"/> </c:when>
	<c:when test="${category eq 'no' }"><c:set var='title' value="방명록"/> </c:when>
