				...
				<div class="col-lg-12">
					<h2>
						<c:if test="${memberVO.member_filepath ne null}">
							<img class="rounded-circle border p-1 picture_member_profile preview" 
								src="${memberVO.member_filepath}" alt="프사" style="margin-bottom: 5px;" />
						</c:if>
						<c:if test="${memberVO.member_filepath eq null}">
							<img class="rounded-circle border p-1 picture_member_profile preview"
								src="images/tot_icon_profile_none.png" alt="프사" style="margin-bottom: 5px;" />
						</c:if>
