    ...
    <div class="shop-detail-box-main">
		...
		<%-- 					<ul>
                       ...
                       <p>${vo.board_content }</p>
						...
						<!-- 		<img src="images/like.png" alt="" style="margin-right: 5px"> -->
						<img src="images/like_gray.png" alt="" style="margin-right: 5px" id="like_img"></a>
								좋아요
								<c:if test="${empty loginInfo or loginInfo.member_id ne vo.like_member_id }">
           				<label for="favorite" onclick="favorites()">
           				<input type="checkbox" id="favorite" >
           				<i class="far fa-heart" ></i></label>
         			</c:if>
		            <c:if test="${!empty loginInfo and loginInfo.member_id eq vo.like_member_id}">
		              	<label for="favorite" onclick="favorites()">
		              	<input type="checkbox" id="favorite" checked="checked" >
		              	<i class="fas fa-heart" style="color: #a370e9"></i></label>
			        </c:if>
			...
			<div class="col my-5">
				<div class="card card-outline-secondary my-4">
					<div class="card-header d-flex justify-content-between align-items-baseline">
						<h2>댓글 보기</h2>
						<a href="newreply.ca"><h6>댓글 쓰기</h6></a>
					</div>
