...
public List<PartyMemberListVO> planMemberListNew(int plan_sn) {
		
		return sql.selectList("party.mapper.planMemberListNew", plan_sn);
	}
	...
	public List<PartyPlanListVO> selectPartyToBack(int plan_sn) {
		return sql.selectList("party.mapper.selectPartyToBack", plan_sn);
	}


	public List<PartyPlanListVO> selectPlanListWithPlanSN(int plan_sn) {
		
		return sql.selectList("party.mapper.selectPlanListWithPlanSN", plan_sn);
	}
