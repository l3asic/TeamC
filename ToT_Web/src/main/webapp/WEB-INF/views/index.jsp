...
<body>
	...
	<div class="main-top">
		<div class="container-fluid">
			<div class="row">
				<div class="text-slid-box">Trip Or Travel 링크 바로가기</div>
			</div>
		</div>
	</div>
	<!-- End Main Top -->
		...
		<nav
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="category_list"><img
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
						<li class="nav-item"><a class="nav-link" href="categpry_list">홈</a></li>
						<li class="dropdown active"><a href="#"	class="nav-link dropdown-toggle arrow" data-toggle="dropdown">카테고리</a>
							<ul class="dropdown-menu">
								...
								<li><a href="shop-detail.html">액티비티</a></li>
								<li><a href="cart.html">지역축제</a></li>
							</ul>
						</li>
	...
	<div id="slides-shop" class="cover-slides">
		<ul class="slides-container">
			<li class="text-center"><img src="https://search.pstatic.net/common?quality=75&direct=true&src=https%3A%2F%2Fcsearch-phinf.pstatic.net%2F20220214_290%2F16448219384906P5EA_JPEG%2F2806474_image2_1.jpg" alt="">
				<div class="container">
					<div class="row">
						<!-- <div class="col-md-12">
							<p>
			...
			<li class="text-center"><img src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=3dba41b5-ea1b-4f33-828c-f390b5b43403" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<p>
