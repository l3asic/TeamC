			...
			<div class="row">
				...
				<div>
					<c:if test="${loginInfo.member_grade eq 'master'}">
						<a class="btn hvr-hover" href="category_write_view?board_class=tour" style="float: right; background-color:transparent; font-size: 15px; color: #999999;">
							여행지 등록 </a>
					</c:if>
				</div>
			</div>
						...
						<div class="product-categorie-box">
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane fade show active"
									id="grid-view" style="align-content: center;">
									<div class="row">
										<%--
												...
												<div class="products-single fix">
													<div class="box-img-hover">
														<%-- <input type="hidden" name="member_id"
															value="${vo.member_id}" /> --%> <a
															href="detail.ca?board_sn=${vo.board_sn }"> <%-- <img
															src="${vo.picture_filepath }" class="img-fluid"> <c:if
																test="${empty vo.picture_filepath }">
