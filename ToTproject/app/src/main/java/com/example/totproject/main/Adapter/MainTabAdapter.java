...
public class MainTabAdapter extends RecyclerView.Adapter<MainTabAdapter.Viewholder> {
    ...
    Context context;
    ArrayList<Board_Common_VO> list;
    LayoutInflater inflater;
    View.OnClickListener listener;
    FragmentManager manager;

    public MainTabAdapter(Context context, ArrayList<Board_Common_VO> list) {
    ...
    public MainTabAdapter(Context context, ArrayList<Board_Common_VO> list, FragmentManager manager) {
