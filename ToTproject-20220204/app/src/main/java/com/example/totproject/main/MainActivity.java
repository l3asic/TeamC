...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       cancel.setOnClickListener(new View.OnClickListener() {
        ...
        TextView mainnav_nickname = nav_headerview.findViewById(R.id.mainnav_nickname);
        mainnav_nickname.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        TextView mainnav_signin = nav_headerview.findViewById(R.id.mainnav_signin);
        mainnav_signin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
