...
public class PartyMemberManageActivity extends AppCompatActivity {
    ...
    LinearLayout lin_party_memberdelete, lin_manage_title, lin_manage_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lin_manage_back =findViewById(R.id.lin_manage_back);

        lin_manage_back.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if (member_list != null){
            ...
            Toast.makeText(PartyMemberManageActivity.this, "가입된 파티원이 없습니다", Toast.LENGTH_SHORT).show();
        }
