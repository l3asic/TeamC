...
import com.example.totproject.category.CategoryVO;
...
public class CommonAsk extends AsyncTask<String,String,InputStream> {
    ...
    final String HTTPIP = "http://192.168.0.195";//IP
    ...
    protected InputStream doInBackground(String... strings) {
        ...
        try{
            ...
            Log.i("asdasd??",postUrl);

            builder = MultipartEntityBuilder.create();
            builder.setMode(HttpMultipartMode.BROWSER_COMPATIBLE);
            Gson gson = new Gson();
            String gridData = gson.toJson(vo);
            ...
            for(int i = 0; i < fileParams.size(); i++){
                ...
                Log.i("asdasd??",(new File(fileParams.get(i).getValue()).length()+""));
            }
